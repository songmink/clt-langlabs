...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityCollection.accesscode'
        db.add_column(u'core_activitycollection', 'accesscode',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityCollection.accesscode'
        db.delete_column(u'core_activitycollection', 'accesscode')
