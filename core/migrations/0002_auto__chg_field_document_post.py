...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.post'
        db.alter_column(u'core_document', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Post'], null=True))

    def backwards(self, orm):

        # Changing field 'Document.post'
        db.alter_column(u'core_document', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 4, 15, 0, 0), to=orm['core.Post']))
