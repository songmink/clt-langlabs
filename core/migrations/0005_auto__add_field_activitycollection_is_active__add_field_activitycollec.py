...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityCollection.is_active'
        db.add_column(u'core_activitycollection', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ActivityCollection.is_public'
        db.add_column(u'core_activitycollection', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityCollection.is_active'
        db.delete_column(u'core_activitycollection', 'is_active')

        # Deleting field 'ActivityCollection.is_public'
        db.delete_column(u'core_activitycollection', 'is_public')
    ...
    models = {
        ...
        u'core.activitycollection': {
            ...
            'accesscode': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
