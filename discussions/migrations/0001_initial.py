...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'discussions_discussionactivity', (
            ...
            ('collection', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='discussions', null=True, on_delete=models.SET_NULL, to=orm['core.ActivityCollection'])),
        ...
        db.create_unique(m2m_table_name, ['discussionactivity_id', 'post_id'])
    ...
    models = {
        ...
        u'discussions.discussionactivity': {
            'Meta': {'object_name': 'DiscussionActivity'},
            'activity_type': ('django.db.models.fields.CharField', [], {'default': "'discussion'", 'max_length': '100'}),
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'discussions'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['core.ActivityCollection']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'display_order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
