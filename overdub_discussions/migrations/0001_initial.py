...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OverdubActivity'
        db.create_table(u'overdub_discussions_overdubactivity', (
            ...
            ('collection', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='overdub', null=True, on_delete=models.SET_NULL, to=orm['core.ActivityCollection'])),
        ...
        db.send_create_signal(u'overdub_discussions', ['OverdubActivity'])

        # Adding M2M table for field posts on 'OverdubActivity'
        m2m_table_name = db.shorten_name(u'overdub_discussions_overdubactivity_posts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('overdubactivity', models.ForeignKey(orm[u'overdub_discussions.overdubactivity'], null=False)),
            ('post', models.ForeignKey(orm[u'core.post'], null=False))
        ))
        db.create_unique(m2m_table_name, ['overdubactivity_id', 'post_id'])


    def backwards(self, orm):
        # Deleting model 'OverdubActivity'
        db.delete_table(u'overdub_discussions_overdubactivity')

        # Removing M2M table for field posts on 'OverdubActivity'
        db.delete_table(db.shorten_name(u'overdub_discussions_overdubactivity_posts'))
    ...
    models = {
        ...
        u'overdub_discussions.overdubactivity': {
            ...
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'overdub'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['core.ActivityCollection']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'display_order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
