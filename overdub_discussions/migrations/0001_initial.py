    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', models.CharField(max_length=400, null=True, blank=True)),
                ('read_after_post', models.BooleanField(default=False)),
                ('private_mode', models.BooleanField(default=False)),
                ('collection', models.ForeignKey(related_name='overdubs', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='core.ActivityCollection', null=True)),
