...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'OverdubActivity.media'
        db.alter_column(u'overdub_discussions_overdubactivity', 'media', self.gf('django.db.models.fields.URLField')(default=datetime.datetime(2014, 5, 12, 0, 0), max_length=200))
    ...
    models = {
        ...
        u'overdub_discussions.overdubactivity': {
            ...
            'media': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'upload_video': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        }
    }
